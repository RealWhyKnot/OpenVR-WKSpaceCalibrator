...
- **In-app updater.** Release builds notice new GitHub releases on launch and offer a one-click upgrade with SHA-256 verification before launching the installer. Dev builds skip the check. See the [In-App Updater](https://github.com/RealWhyKnot/OpenVR-SpaceCalibrator/wiki/In-App-Updater) wiki page.
