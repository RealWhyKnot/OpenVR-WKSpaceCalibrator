...
**What it does:** drops sample pairs whose rotation axis disagrees with the consensus before the LS solve. Stiffens the math against intermittent USB glitches, brief tracking loss, or a tracker that briefly tracks through occlusion.
